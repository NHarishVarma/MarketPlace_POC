...
import styles from "./CompareLookFeel2.module.css";

const CompareLookFeel2: FunctionComponent = () => {
  ...
  const onComponent21228Click = useCallback(() => {
    navigate("/compare-look-feel-3");
  }, [navigate]);

  const onComponent21229Click = useCallback(() => {
    navigate("/compare-look-feel-1");
  }, [navigate]);

  return (
    <div className={styles.compareLookFeel2}>
      <div className={styles.compare}>Compare</div>
      <div className={styles.bg} />
      <div className={styles.component21222}>
      ...
      <div className={styles.component21223}>
        <div className={styles.buttonNormal}>
      ...
      <div className={styles.component21224}>
        <div className={styles.buttonNormal}>
          <div className={styles.buttonNormalChild} />
          <div className={styles.subscribe}>Subscribe</div>
        </div>
      ...
      <div className={styles.component21225}>
        <div className={styles.buttonNormal}>
          <div className={styles.buttonNormalItem} />
          <div className={styles.viewDetail}>View Detail</div>
        </div>
      ...
      <div className={styles.component21226}>
        <div className={styles.buttonNormal}>
          <div className={styles.buttonNormalChild} />
          <div className={styles.subscribe2}>Subscribe</div>
        </div>
      </div>
      <div className={styles.component21227}>
        <div className={styles.buttonNormal}>
          <div className={styles.buttonNormalItem} />
          <div className={styles.viewDetail}>View Detail</div>
        </div>
      ...
      <img
        className={styles.component2098}
        alt=""
      ...
      <div className={styles.compareLookFeel2Child} />
      <div className={styles.bgParent}>
        <div className={styles.bg5} />
        <div className={styles.component21228} onClick={onComponent21228Click}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalChild} />
            <div className={styles.remove}>Remove</div>
          </div>
        </div>
        <div className={styles.component21229} onClick={onComponent21229Click}>
          <div className={styles.buttonNormal}>
            <div className={styles.buttonNormalItem} />
        ...
        <div className={styles.areYouSureContainer}>
          ...
          >{`Are you sure you would like to remove this fund from `}</p>
          <p className={styles.areYouSure}>Your compare list?</p>
        </div>
        <img
...
export default CompareLookFeel2;

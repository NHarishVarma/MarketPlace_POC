...
import styles from "./CompareLookFeel3.module.css";

const CompareLookFeel3: FunctionComponent = () => {
  ...
  return (
    <div className={styles.compareLookFeel3}>
      <div className={styles.compare}>Compare</div>
      <div className={styles.bg} />
      <div className={styles.component21230}>
      ...
      <div className={styles.component21231}>
        <div className={styles.buttonNormal}>
      ...
      <div className={styles.component21232}>
        <div className={styles.buttonNormal}>
          <div className={styles.buttonNormalChild} />
          <div className={styles.subscribe}>Subscribe</div>
        </div>
      ...
      <div className={styles.component21233}>
        <div className={styles.buttonNormal}>
          <div className={styles.buttonNormalItem} />
          <div className={styles.viewDetail}>View Detail</div>
        </div>
      ...
      <div className={styles.addToCompare2}>
...
export default CompareLookFeel3;
